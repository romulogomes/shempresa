...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:21,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Próximo",sPrevious:"Anterior"},sEmptyTable:"Não foi encontrado dados para serem mostrados",sInfo:"Total _START_ de _END_ de _TOTAL_ Registros",sInfoEmpty:"Total 0 de 0 de 0 Registros",sInfoFiltered:"(filtrados de _MAX_ Total Registros)",sInfoPostFix:"",sDecimal:"",
